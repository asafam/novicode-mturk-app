...
import SecondaryPane from './Sidebar'
import Form from './Utterance';
            ...
            <div className="utterances">
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col">
                            <SecondaryPane header={header} instructions={instructions} utterance={utterance} progress={progress} hideHeader={status === STATUS.end} hideHelp={status === STATUS.end} hideUtterance={status === STATUS.utteranceVerification} />
                        </div>
                        <div className="col">
                            {status === STATUS.utterancePhrasing &&
